...
public class JavaTutorial30 extends JFrame{
	...
	public JavaTutorial30() {
		...
		addComp(thePanel, streetLabel, 1, 1, 2, 1, GridBagConstraints.WEST, GridBagConstraints.NONE);
		...
		//Other options: VERTICAL_SCROLLBAR_ALWAYS, VERTICAL_SCROLLABAR_NEVER
	...
	//Sets the rules for component destined for a GridBagLayout and then adds it

...
//In swing you use a JFrame, to make the program work online you use JApplet

@SuppressWarnings("serial")
public class JavaTutorial40 extends JApplet{
	...
	public void init() {
		...
		//Assigns an object that will monitor this button clicks
	...
	class GetResultsListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			...
			String pageToOpen = "", 
					directoryLoc = "file://Code/Java/Java Youtube/Java_Tutorials_40/src/";
			...
			if(e.getSource() == getResultBut) {
				...
				textToDisplay += pageToOpen + ".png" + "\" /></div></html>";
				...
				//Add the JEditorPane to a scroller and define how to handle scrollbars

...
public class JavaTutorial38 extends JFrame{
	...
	public static void main(String[] args) {
		...
		//A connection object is sused to provide access to a database
		...
		try {
			...
			//getConnectino establishes a connection to the database
			//You must also pass the userid and password for the database
			
			conn = DriverManager.getConnection("jdbc:mysql://localhost/samp_db", "root", "AEROspace2014////");
			...
			//It cannot be changed and can only be read in one direction
		...
		//Increase the font size for the cells in teh table
		...
		//Creates a button that when pressed executes the code in the method action performed
		...
		table.addMouseListener(new MouseAdapter() {
			public void mouseReleased(MouseEvent me) {
				...
				//Make sure a value is hanged only if OK is clicked
				if(value != null) {

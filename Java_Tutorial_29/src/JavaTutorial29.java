...
public class JavaTutorial29 extends JFrame{
	...
	public JavaTutorial29() {
		...
		//Create a Grid Layout with as many rows as needed and 3 columns. 
		//The Last 2 parameters create a horizontal gap of 2 pixels and a vertical gap of 2 pixels
		
		//thePanel.setLayout(new GridLayout(0,3,2,2));
		
		thePanel.setLayout(new GridBagLayout());
		
		//You create a GridBagConstraints object that defines defaults for your components
		...
		//Gives the layout manager a hind on how to adjust component width (0 equals fixed)

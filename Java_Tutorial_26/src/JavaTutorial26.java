...
public class JavaTutorial26 extends JFrame{
	...
	private class ListenForButton implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == button1) {
				...
				JOptionPane.showMessageDialog(JavaTutorial26.this, outputString, "Information", JOptionPane.INFORMATION_MESSAGE);
